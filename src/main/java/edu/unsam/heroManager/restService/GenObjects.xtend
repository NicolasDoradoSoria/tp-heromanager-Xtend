...
class GenObjects {
	...
	def static addToRepo() {
		...
		val infinity = new ItemSimple() => [
			nombre = "Filo del infinito"
			photoUrl="https://i.ytimg.com/vi/Nq6vPOh-3JI/hqdefault.jpg"
			alcance = 5.0
			danio = 65.0
			peso = 7.0
			resistencia = 2.0
		...
		val ludens = new ItemSimple() => [
			nombre = "Eco de luden"
			photoUrl="https://img.rankedboost.com/wp-content/uploads/2019/06/Ludens-Echo-Teamfight-Tactics.png"
			alcance = 5.0
			danio = 80.0
			peso = 7.0
			resistencia = 2.0
		...
		val canon = new ItemSimple() => [
			nombre = "Cañon de fuego rapido"
			photoUrl="https://pm1.narvii.com/6535/245fc1a40cf6f81248ca015d2a5734c463d2681d_hq.jpg"
			alcance = 30.0
			danio = 20.0
			peso = 7.0
			resistencia = 2.0
		...
		val rabadon = new ItemSimple() => [
			nombre = "Sombrero mortal de rabadon"
			photoUrl="https://image.spreadshirtmedia.com/image-server/v1/compositions/T210A2PA3176PT17X0Y36D12589371FS5213/views/1,width=650,height=650,appearanceId=2/item-rabadons-deathcap-from-league-of-legends.jpg"
			alcance = 30.0
			danio = 120.0
			peso = 20.0
			resistencia = 2.0
		...
		val sunfire = new ItemSimple() => [
			nombre = "Capa de fuego solar"
			photoUrl="https://pbs.twimg.com/profile_images/486650087796273154/xz1CJsoo_400x400.png"
			alcance = 3.0
			danio = 5.0
			peso = 20.0
			resistencia = 200.0
		...
		val compra = new Compra =>[
			fechaCompra = LocalDate.of(2019,11,22)
			item = espada
			cantidad = 10
		]
